...
set_word_pointer:
    mov     word word_pointer[0], word_1
    mov     word word_pointer[2], word_2
    mov     word word_pointer[4], word_3
    mov     word word_pointer[6], word_4
    mov     word word_pointer[8], word_5
    ret 
